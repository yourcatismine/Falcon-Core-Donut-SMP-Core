...
import com.falconcore.survival.orders.cmd.OrdersCommand;
import com.falconcore.survival.orders.gui.MenuListener;
import com.falconcore.survival.orders.input.ChatInputManager;
import com.falconcore.survival.orders.store.ConfigManager;
import com.falconcore.survival.orders.store.EnchantmentsManager;
import com.falconcore.survival.orders.store.FilterManager;
import com.falconcore.survival.orders.store.OrderManager;
import com.falconcore.survival.orders.store.PlayerStateManager;
import com.falconcore.survival.orders.store.VaultHook;
import com.falconcore.survival.orders.store.OfflineNotificationManager;
import com.falconcore.survival.orders.gui.OrdersJoinListener;
...
public class OrdersModule {
    ...
    private com.falconcore.survival.orders.util.PlayerNameCache nameCache;
    private OfflineNotificationManager offlineNotifications;

    public OrdersModule(Falcon plugin) {
        this.plugin = plugin;
    }
    ...
    public void enable() {
        ...
        this.nameCache = new com.falconcore.survival.orders.util.PlayerNameCache(plugin);
    ...
    public com.falconcore.survival.orders.util.PlayerNameCache getNameCache() {
