...
public class FalconEconomy implements Economy {

    private final Falcon plugin;

    public FalconEconomy(Falcon plugin) {
        this.plugin = plugin;
    }
    ...
    public EconomyResponse withdrawPlayer(OfflinePlayer player, double amount) {
        ...
        String source = com.falconcore.survival.auction.EconomyHandler.getSourceContext();
        if (source == null)
            source = "Vault";
