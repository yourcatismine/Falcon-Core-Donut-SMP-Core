...
public class EnchantmentsManager {
    ...
    private void loadFromFile() {
        ...
        this.module.getPlugin().getLogger()
                .info("[Enchantments] Loaded " + this.byCategory.values().stream().mapToInt(List::size).sum()
                        + " options across " + this.byCategory.size() + " categories. Pinned: mending="
                        + this.pinnedMending + " unbreaking=" + String.valueOf(this.pinnedUnbreaking));
    }
    ...
    private void mapMaterials() {
        ...
        this.module.getPlugin().getLogger()
                .info("[Enchantments] Material category map size=" + this.materialCategory.size());
    }
