...
public class WarpManager {
    ...
    public void setWarp(String name, Location loc) {
        ...
        if (plugin.getFalconSell().getDatabaseManager().isFlatfileMode() || !plugin.getFalconSell().getDatabaseManager().isConnected()) {
            warpsConfig.set(name.toLowerCase(), serialized);
            saveFlatfile();
            return;
        }
    ...
    public Location getWarp(String name) {
        if (plugin.getFalconSell().getDatabaseManager().isFlatfileMode() || !plugin.getFalconSell().getDatabaseManager().isConnected()) {
            String raw = warpsConfig.getString(name.toLowerCase());
