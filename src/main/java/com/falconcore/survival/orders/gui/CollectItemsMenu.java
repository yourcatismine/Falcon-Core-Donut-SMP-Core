                ...
                if (slot == drop) {
                    ...
                    for (ItemStack item : toDrop) {
                        if (item != null && item.getType() != Material.AIR) {
                            ...
                            PlayerData pd = Falcon.getInstance().getPlayerDataManager()
                                    .loadPlayer(this.p.getUniqueId());
                            if (pd != null) {
                                pd.addHistory(log);
                                Falcon.getInstance().getPlayerDataManager()
                ...
                if (index >= 0 && index < this.order.storage.size()) {
                    ...
                    if (item != null && item.getType() != Material.AIR) {
                        ...
                        if (action == org.bukkit.event.inventory.InventoryAction.MOVE_TO_OTHER_INVENTORY) {
                            com.falconcore.survival.tools.ToolsManager.getInstance().resumeOrdersTimers(toAdd);
                            ...
                            if (cursor == null || cursor.getType() == Material.AIR) {
                                ...
                                com.falconcore.survival.tools.ToolsManager.getInstance().resumeOrdersTimers(taking);
                                ...
                                if (cursorStripped.isSimilar(toAdd)) {
                                    ...
                                    if (canTake > 0) {
                                        ...
                                        if (toTake > 0) {
                                            ...
                                            com.falconcore.survival.tools.ToolsManager.getInstance()
