...
public class AdminOrderDetailsMenu implements InventoryHolder, MenuOwner {
    ...
    public void cancelAndRefund(Order o) {
        com.falconcore.survival.auction.AuctionController auction = com.h2ph.Falcon.getInstance()
                ...
                for (ItemStack item : o.storage) {
                    ...
                    if (delivererUuidStr != null) {
                        try {
                            ...
                            com.falconcore.survival.auction.AuctionItem ai = new com.falconcore.survival.auction.AuctionItem(
                                    UUID.randomUUID(),
                                    delivererName,
                                    item,
                                    0.0,
